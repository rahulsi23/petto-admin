        ...
        <table className="table table-row-dashed">
          <thead>
            <tr className="fw-bolder text-muted">
              ...
              <th className="w-250px">Order By</th>
              <th className="w-150px text-center">Date & Time</th>
              <th className="w-70px text-center">Items</th>
              <th className="w-70px text-center">Price</th>
              <th className="w-150px text-center">Payment Status</th>
              <th className="w-150px text-center">Order Status</th>
              <th className="w-150px text-center">Driver</th>
                ...
                return (
                  <tr key={item.orderId} className="">
                    ...
                    <td className="text-center">
                      <span className="text-danger">COD</span>
                      {/* <span className="text-success">Online</span> */}
                    </td>
                    <td className="text-center">
                      {acceptedOrderDetails?.id !== item.id && !item.driver && (
                        <div className="ordrstats-acprjct">
                          ...
                          <span className="ordrstats-icon rejct-icon"  onClick={handleDeletePopup}>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="24"
                              height="24"
                    ...
                    <td className="text-center">
                      <div className="driveraster-assign">
                        <span className={`${item.driver ? '' : 'text-danger'}`}>
                          {item.driver ? item.driver : "Not Assigned"}
                        </span>
                      </div>
                    </td>
                    <td className="">
