...
import {DeleteAlertPopup, PopupEditCategory} from "./index";
...
const PetsCategoryTable = () => {
  const [showEditPopCategory, setShowEditPopCategory] = useState(false);
  ...
  return (
    <>
            ...
            {orders && orders.map((item, index) => {
              return (
                <tr key={item.orderId} className="">
                  ...
                  <span class="brndimg-main m-auto">
      ...
      {showEditPopCategory && <PopupEditCategory handlePopup={handlePopup}/>}
...
export default PetsCategoryTable