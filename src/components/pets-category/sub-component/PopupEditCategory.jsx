...
const PopupEditCategory = ({handlePopup}) => {
              ...
              <div className="popup-body">
                ...
                <div className="form-inputs">
                   ...
                   Title<i>*</i>
                    ...
                    <input type="text" name="fullname" className="form-control" placeholder="Enter category here" value="Dog" />
                  </div>
                  <div className="form-inputs">
