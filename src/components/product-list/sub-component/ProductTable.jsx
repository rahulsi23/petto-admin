        ...
        <table className="table table-row-dashed">
          <thead>
            <tr className="fw-bolder text-muted">
              ...
              <th className="w-250px">Products</th>
              <th className="w-100px text-center">Pets Category</th>
              <th className="w-100px text-center">Product Category</th>
              ...
              orders.map((item, index) => {
                return (
                  <tr key={item.orderId} className="">
                    ...
                    <td className="text-center">{item.petCategory}</td>
