...
import {DeleteAlertPopup, PopupEditProductCategory} from "./index";
const orders = [
  {
    prdctCategory: 'Shampoo',
  },
  {
    prdctCategory: 'Biscuits',
  },
  {
    prdctCategory: 'Food',
  },
  {
    prdctCategory: 'Dry Food',
  },
...
const ProductCategoryTable = () => {
  const [showEditPopProductCategory, setShowEditPopProductCategory] = useState(false);
  ...
  const handlePopup = () => {
    setShowEditPopProductCategory((p) => !p);
  };
  return (
    <>
        ...
        <table className="table table-row-dashed">
          <thead>
            <tr className="fw-bolder text-muted">
              ...
              <th className="w-250px">Product Category</th>
            ...
            {orders && orders.map((item, index) => {
              return (
                <tr key={item.orderId} className="">
                  ...
                  <td className=""> {item.prdctCategory}</td>
                  <td className="">
      ...
      {showEditPopProductCategory && <PopupEditProductCategory handlePopup={handlePopup}/>}
