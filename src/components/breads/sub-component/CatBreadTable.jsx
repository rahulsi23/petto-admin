...
import {DeleteAlertPopup, PopupEditBreads} from "./index";
const orders = [
  {
    breadName: 'Exotic Shorthair',
  },
  {
    breadName: 'Ragdoll',
  },
  {
    breadName: 'British Shorthair',
  },
  {
    breadName: 'Persian',
  },
...
const  CatBreadTable = () => {
    const [showEditPopBreads, setShowEditPopBreads] = useState(false);
  ...
  return (
    <>
        ...
        <table className="table table-row-dashed">
          <thead>
            <tr className="fw-bolder text-muted">
              ...
              <th className="w-250px">Bread Name</th>
      ...
      {showEditPopBreads && <PopupEditBreads handlePopup={handlePopup}/>}
